...
REMOTE_LINK="https://github.com/paritytech/staking-miner-v2/pull/"
...
function generate_changelog() {
    ...
    prs=$($GIT_BIN --no-pager log --pretty=format:"%s" "$tag"..origin/main) || log_error 'Failed to obtain commit list'
...
tag=$($GIT_BIN describe --match "v[0-9]*" --abbrev=0 origin/main) || log_error 'Failed to obtain the latest release tag'
