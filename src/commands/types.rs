...
pub struct DryRunConfig {
	...
	/// is used as-is. If this is not provided, we won't attempt to submit anything.
	///
...
pub struct MonitorConfig {
	...
	/// If the extrinsic is invalid then the submission is ignored and the next block will
	/// attempted again.
	///
	/// This requires a RPC endpoint that exposes unsafe RPC methods, if the RPC endpoint doesn't
	/// expose unsafe RPC methods then the miner will be terminated.
	#[clap(long)]
	pub dry_run: bool,
}
